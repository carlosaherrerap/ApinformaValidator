/**
 * Envío de SMS vía InformaPerú API
 * Endpoint: POST /sms/send-unique-message
 * Autenticación: Basic Auth
 */

const SMS_BASE_URL = process.env.SMS_BASE_URL || 'https://api.informaperu.com/';
const SMS_USERNAME = process.env.SMS_USERNAME || 'asdasda';
const SMS_PASSWORD = process.env.SMS_PASSWORD || 'asdsadasda';
 ...
 * number - Celular de 9 dígitos (sin código de país)
